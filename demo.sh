...
python3 src/main.py train_glove --counter-file "./resources/counter.pkl" --cooccurrence-matrix "./resources/cooccurrence_matrix.npz" --output-path "./resources/glove_embedder.pkl" && \
